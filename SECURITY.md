...
Network Manager Pro is a Windows desktop utility that can run elevated and change local DNS, proxy, and startup settings. Treat configuration files and plugins as sensitive local data.
